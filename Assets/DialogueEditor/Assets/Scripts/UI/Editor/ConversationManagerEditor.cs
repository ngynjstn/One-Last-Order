...
namespace DialogueEditor
{
    ...
    public class ConversationManagerEditor : Editor
    {
        ...
        SerializedProperty DialogueOptionsAppearAudioProperty;
        SerializedProperty DialogueOptionsChooseAudioProperty;
        SerializedProperty DialogueOptionsHoverAudioProperty;
        SerializedProperty DialogueScrollingAudioProperty;
        ...
        private void OnEnable()
        {
            ...
            DialogueOptionsAppearAudioProperty =  serializedObject.FindProperty("DialogueOptionsAppearAudio");
            DialogueOptionsChooseAudioProperty = serializedObject.FindProperty("DialogueOptionsChooseAudio");
            DialogueOptionsHoverAudioProperty = serializedObject.FindProperty("DialogueOptionsHoverAudio");
            DialogueScrollingAudioProperty = serializedObject.FindProperty("DialogueScrollingAudio");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(DialogueOptionsAppearAudioProperty);
            EditorGUILayout.PropertyField(DialogueOptionsHoverAudioProperty);
            EditorGUILayout.PropertyField(DialogueOptionsChooseAudioProperty);
            EditorGUILayout.PropertyField(DialogueScrollingAudioProperty);
            EditorGUILayout.Space();
