...
namespace DialogueEditor
{
    public class ConversationManager : MonoBehaviour
    {
        ...
        public AudioClip DialogueOptionsAppearAudio;
        public AudioClip DialogueOptionsChooseAudio;
        public AudioClip DialogueOptionsHoverAudio;
        public AudioClip DialogueScrollingAudio;
        ...
        private void ScrollingText_Update()
        {
            ...
            if (m_elapsedScrollTime > timePerChar)
            {
                ...
                m_scrollIndex++;
                AudioPlayer.PlayOneShot(DialogueScrollingAudio,0.5f);
                // Finished?
                if (m_scrollIndex >= m_targetScrollTextCount)
                {
                    AudioPlayer.PlayOneShot(DialogueOptionsAppearAudio,1f);
        ...
        {
            AudioPlayer.PlayOneShot(DialogueOptionsHoverAudio, 0.5f);
            if (m_uiOptions.Count == 0) { return; }
